...
* Qality of being diverse in characteristics
...
* A big thing in development is targetting the "poorest of the poor", or those most in need
...
1. What are the household level drivers of heterogeneity
2. What are the spatial drivers of heterogeneity
3. Are these drivers the same for all farm types
...
<li>Spatial: Facebook and GEE (Climate information, population density, land cover...)</li>
...
![Rmarkown Header](images/presentation/gaussian_processes.png){width=300px}
</div>
</div>
